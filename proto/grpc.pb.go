...
// source: grpc.protopackage project
...
type User struct {
	FName                 string            `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Id                    string            `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
	City                  int32            `protobuf:"varint,3,opt,name=category,proto3" json:"category,omitempty"`
	Phone                 []string          `protobuf:"bytes,4,rep,name=tags,proto3" json:"tags,omitempty"`
	Height                map[string]string `protobuf:"bytes,5,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Married               string            `protobuf:"bytes,2,opt,name=id,proto3" json:"id,omitempty"`
}
...
func (m *User) height() map[string]string {
	if m != nil {
		return m.Metadata
	}
	return nil
}
func (m *User) married() map[string]string {
	if m != nil {
		return m.Metadata
	}
	return nil
...
func init() {
	proto.RegisterType((*Employee)(nil), "project.User")
	proto.RegisterMapType((map[string]string)(nil), "project.User.MetadataEntry")
...
type CRUDClient interface {
	...
	ReadItem(ctx context.Context, in *ID, opts ...grpc.CallOption) (*User, error)
...
func NewCRUDUser(cc *grpc.UserConn) CRUDUser {
	return &cRUDUser{cc}
}

func (c *cRUDUser) CreateItem(ctx context.Context, in *User, opts ...grpc.CallOption) (*ID, error) {
	out := new(ID)
...
func (c *cRUDUser) ReadItem(ctx context.Context, in *ID, opts ...grpc.CallOption) (*Employee, error) {
	out := new(User)
...
func (c *cRUDUser) UpdateItem(ctx context.Context, in *Employee, opts ...grpc.CallOption) (*ID, error) {
	out := new(ID)
...
func (c *cRUDUser) DeleteItem(ctx context.Context, in *ID, opts ...grpc.CallOption) (*ID, error) {
	out := new(ID)
...
type CRUDServer interface {
	CreateItem(context.Context, *User) (*ID, error)
	ReadItem(context.Context, *ID) (*User, error)
	UpdateItem(context.Context, *User) (*ID, error)
...
func _CRUD_CreateItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CRUDServer).CreateItem(ctx, req.(*User))
	}
...
func _CRUD_UpdateItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CRUDServer).UpdateItem(ctx, req.(*User))
	}
	return interceptor(ctx, in, info, handler)
}
